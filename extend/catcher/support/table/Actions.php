...
use catcher\support\table\components\Button;
...
class Actions
{
     ...
     * @return Button
     */
    public static function store(string $text = '新建', string $event = 'handleCreate'): Button
    {
     ...
     * @return Button
     */
    public static function normal(string $text, string $type = '', string $event = null): Button
    {
        $button = (new Button)
            ->size('mini')
            ->type($type)
