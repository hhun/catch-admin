 ...
 * @method $this disabled(bool $disabled = true) 是否为只读, 默认值: false
 * @method $this allowHalf(bool $allowHalf = true) 是否允许半选, 默认值: false
 ...
 * @method $this showText(bool $showText = true) 是否显示辅助文字，若为真，则会从 texts 数组中选取当前分数对应的文字内容, 默认值: false
 * @method $this showScore(bool $showScore) = true 是否显示当前分数，show-score 和 show-text 不能同时为真, 默认值: false
