...
use catch\support\table\traits\Attributes;
use catch\support\table\traits\Events;
use catch\support\table\traits\Header;
use think\Model;
use catch\support\table\traits\Actions;
use catch\support\table\traits\Search;
use Closure;
