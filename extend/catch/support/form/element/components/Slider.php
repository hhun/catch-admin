 ...
 * @method $this showInput(bool $showInput = true) 是否显示输入框，仅在非范围选择时有效, 默认值: false
 * @method $this showInputControls(bool $showInputControls = true) 在显示输入框的情况下，是否显示输入框的控制按钮, 默认值: true
 * @method $this inputSize(string $inputSize) 输入框的尺寸, 可选值: large / medium / small / mini, 默认值: small
 * @method $this showStops(bool $showStops = true) 是否显示间断点, 默认值: false
 * @method $this showTooltip(bool $showTooltip = true) 是否显示 tooltip, 默认值: true
 * @method $this range(bool $range = true) 是否为范围选择, 默认值: false
 * @method $this vertical(bool $vertical = true) 是否竖向模式, 默认值: false
...
class Slider extends FormComponent
{
    ...
    {
        return $this->props['range'] ? ValidateFactory::validateArr() : ValidateFactory::validateNum();
    }
}
