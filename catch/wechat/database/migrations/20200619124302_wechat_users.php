...
class WechatUsers extends Migrator
{
    ...
    {
        $table = $this->table('wechat_users', ['engine' => 'Innodb', 'collation' => 'utf8mb4_general_ci', 'comment' => ' 微信用户表', 'signed' => false]);
        $table->addColumn('nickname', 'string', ['limit' => 30,'default' => '','comment' => '用户名'])
            ->addColumn('avatar', 'string', ['limit' => 255,'comment' => '用户头像'])
            ->addColumn('openid', 'string', ['limit' => 35, 'comment' => 'openid'])
            ->addColumn('language', 'string', ['limit' => 20, 'comment' => '语言'])
            ->addColumn('country', 'string', ['limit' => 20, 'comment' => '国家'])
            ->addColumn('province', 'string', ['limit' => 20, 'comment' => '省份'])
            ->addColumn('city', 'string', ['limit' => 20, 'comment' => '城市'])
            ->addColumn('subscribe', 'boolean', ['limit' => 1,'default' => 1,'comment' => '用户状态  0 取消订阅  1 订阅'])
            ->addColumn('block', 'boolean', ['limit' => 1,'default' => 1,'comment' => '拉黑状态  1 正常  2 拉黑'])
            ->addColumn('subscribe_time', 'integer', ['default' => 0,'comment' => '订阅时间', 'signed' => false])
            ...
            ->addColumn('sex', 'boolean', ['limit' => 1,'default' => 1,'comment' => '用户状态 1 男 2 女 0 未知'])
